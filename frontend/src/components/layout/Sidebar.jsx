...
const LogoIcon = () => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
    <path d="M11.7 2.805a.75.75 0 0 1 .6 0A60.65 60.65 0 0 1 22.83 8.72a.75.75 0 0 1-.231 1.37 59.15 59.15 0 0 1-10.463 6.33.75.75 0 0 1-.926-.94163.75.75 0 0 1 .926.94163 60.65 60.65 0 0 1-9.193-6.215.75.75 0 0 1-.232-1.37c3.684-.315 6.977-.906 9.664-1.782Z" />
    <path d="M13.446 2.824a.75.75 0 0 1 .6 0A60.654 60.654 0 0 1 24 8.835a.75.75 0 0 1-.231 1.37 59.16 59.16 0 0 1-10.463 6.33.75.75 0 0 1-.926-.94163.75.75 0 0 1 .926.94163 60.654 60.654 0 0 1-9.193 6.215.75.75 0 0 1-.232-1.37c3.684-.315 6.977-.906 9.664-1.782Z" />
  </svg>
);
...
const adminNavItems = [
  ...
  { path: '/admin/faculty', label: 'Faculty', icon: <FacultyIcon /> },
 ...
 */
function Sidebar({ role = 'ADMIN', isOpen = false, onClose }) {
        ...
        <nav className="sidebar-nav">
          {navItems.map((item) => (
            <NavLink
              ...
              end={item.path === `/${userRole.toLowerCase()}/dashboard`}
