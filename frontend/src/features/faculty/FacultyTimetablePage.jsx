...
import { getFacultyTimetable, organizeTimetableByDay } from '../../services/timetableService';
...
function FacultyTimetablePage() {
  ...
  return (
    <DashboardLayout title="My Teaching Timetable">
      ...
      <style>{`
        ...
        .timetable-entry { position: absolute; top: 2px; left: 2px; right: 2px; bottom: 2px; background: linear-gradient(135deg, var(--primary-color), var(--primary-light)); color: white; padding: 8px; border-radius: 6px; font-size: 0.8rem; display: flex; flex-direction: column; justify-content: center; }
        .entry-course { font-weight: bold; font-size: 0.85rem; }
        .entry-code { opacity: 0.9; font-size: 0.75rem; }
        .entry-room { opacity: 0.8; font-size: 0.75rem; margin-top: 4px; }
